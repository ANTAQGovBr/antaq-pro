...
## ![ANTAQ Pro Desativar funções da extensão](../img/icon-desativarfuncoes.png) Desativar funções da extensão 
...
Para isso, acesse as opções da extensão clicando com o botão direito sobre o ícone do **ANTAQ Pro** na barra de extensões do Google Chrome:
