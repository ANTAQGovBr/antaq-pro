...
function insertIconFavorites() {
    waitLoadPro($('#ifrArvore').contents(), '#topmenu', "a[target='"+ifrVisualizacao_+"']", appendIconFavorites);
}
function appendIconFavorites() {
    var ifrArvore = $('#ifrArvore').contents(); 
    var iconProc = ifrArvore.find('#topmenu a[target="'+ifrVisualizacao_+'"]').eq(0);
    ...
    ifrArvore.find('#topmenu a[target="'+ifrVisualizacao_+'"]').eq(0).after(iconStar);    
}
